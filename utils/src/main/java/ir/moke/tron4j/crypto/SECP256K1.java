 ...
 */
package ir.moke.tron4j.crypto;

import ir.moke.tron4j.crypto.tuwenitypes.Bytes;
import ir.moke.tron4j.crypto.tuwenitypes.Bytes32;
import ir.moke.tron4j.crypto.tuwenitypes.MutableBytes;
import ir.moke.tron4j.crypto.tuwenitypes.UInt256;
...
public class SECP256K1 {
     ...
     * @param signature    ASN.1 encoded signature.
     * @param pub          The public key bytes to use.
     * @param preprocessor The function to apply to the data before verifying the signature, normally a hashing function.
     * @return True if the verification is successful.
     */
    ...
    public static class Signature {
         ...
         * correct one. Because the key recovery operation yields multiple potential keys, the correct key must either be stored alongside the signature, or you must be willing to try each recId in turn until you find one that outputs the key you are expecting.
         */
