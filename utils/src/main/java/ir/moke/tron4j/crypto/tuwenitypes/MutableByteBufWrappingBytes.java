...
final class MutableByteBufWrappingBytes extends ByteBufWrappingBytes implements MutableBytes {
    ...
    MutableByteBufWrappingBytes(ByteBuffer buffer) {
        super(buffer);
    }

    MutableByteBufWrappingBytes(ByteBuffer buffer, int offset, int length) {
    ...
    public void setInt(int i, int value) {
        byteBuf.putInt(i, value);
        byteBuf.flip();
    }

    @Override
    public void setLong(int i, long value) {
        byteBuf.putLong(i, value);
        byteBuf.flip();
    }
