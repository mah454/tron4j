...
public final class UInt256 implements UInt256Value<UInt256> {
     ...
     *
     * @param str The hexadecimal string to parse, which may or may not start with "0x". That representation may contain less than 32 bytes, in which case the result is left padded with zeros.
