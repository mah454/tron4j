...
public interface MutableBytes32 extends MutableBytes, Bytes32 {
     ...
     * @return A {@link MutableBytes32} that exposes the bytes of {@code value} from {@code offset} (inclusive) to {@code offset + 32} (exclusive).
     ...
     *
     * <p>
     * Note that the value is not copied, and thus any future update to {@code value} within the wrapped parts will be reflected in the returned value.
     *
     * @param value  The bytes to wrap.
