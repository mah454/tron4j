...
import ir.moke.tron4j.abi.datatypes.AbiTypes;
import ir.moke.tron4j.abi.datatypes.Array;
import ir.moke.tron4j.abi.datatypes.DynamicArray;
 ...
 */
public abstract class TypeReference<T extends ir.moke.tron4j.abi.datatypes.Type>
    ...
    public static <T extends ir.moke.tron4j.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
        return create(cls, false);
    }

    public static <T extends ir.moke.tron4j.abi.datatypes.Type> TypeReference<T> create(
     ...
     */
    protected static Class<? extends ir.moke.tron4j.abi.datatypes.Type> getAtomicTypeClass(
    ...
    public abstract static class StaticArrayTypeReference<T extends ir.moke.tron4j.abi.datatypes.Type>
    ...
    public static TypeReference makeTypeReference(
        ...
        if (!nextSquareBrackets.find()) {
            final Class<? extends ir.moke.tron4j.abi.datatypes.Type> typeClass =
        ...
        final Class<? extends ir.moke.tron4j.abi.datatypes.Type> baseClass =
