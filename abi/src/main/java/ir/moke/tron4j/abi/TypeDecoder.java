...
import ir.moke.tron4j.abi.datatypes.*;
...
/**
 * Ethereum Contract Application Binary Interface (ABI) decoding for types. Decoding is not documented, but is the reverse of the encoding details located <a href="https://github.com/ethereum/wiki/wiki/Ethereum-Contract-ABI">here</a>.
 */
public class TypeDecoder {
    ...
    static Type instantiateArrayType(TypeReference ref, Object value)
        ...
        if (arraySize <= 0) {
            ...
            Class<?> arrayClass =
                    Class.forName("ir.moke.tron4j.abi.datatypes.generated.StaticArray" + arraySize);
        ...
        try {
            Class<? extends StaticArray> arrayClass =
                    (Class<? extends StaticArray>)
                            Class.forName("ir.moke.tron4j.abi.datatypes.generated.StaticArray" + length);
